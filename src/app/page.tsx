...
export default function Home() {
  const featuredProducts = products.filter(p => ['1', '8', '7', '3'].includes(p.id));
    ...
    <div className="flex flex-col">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid grid-cols-1 gap-6 py-12 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
